...
use common\modules\orderPayment\WOP\OnlinePayments\Sdk\TestUtil\AppendingBodyHandler;
...
class CommunicatorTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->defaultResponseClassMap->defaultSuccessResponseClassName = 'common\modules\orderPayment\WOP\OnlinePayments\Sdk\SimpleHttpBinResponse';
        $this->defaultResponseClassMap->defaultErrorResponseClassName = 'common\modules\orderPayment\WOP\OnlinePayments\Sdk\TestUtil\TestErrorResponse';
    }
    ...
    public function testApiRequestGet()
    {
        ...
        $this->assertInstanceOf('common\modules\orderPayment\WOP\OnlinePayments\Sdk\SimpleHttpBinResponse', $response);
