...
namespace common\modules\orderPayment\WOP\OnlinePayments\Sdk\Authentication;
...
class V1HmacAuthenticatorTest extends TestCase
{
    ...
    public function testCreateAuthenticationSignature()
    {
        ...
        $authenticator = new V1HmacAuthenticator($configuration);
        $requestHeaders = ['Content-Type' => 'application/json', 'Date' => 'Fri, 06 Jun 2014 13:39:43 GMT', 'x-gcs-clientmetainfo' => 'processed header value', 'x-gcs-customerheader' => 'processed header value', 'x-gcs-servermetainfo' => 'processed header value'];
    ...
    public function testCreateAuthenticationSignature2()
    {
        ...
        $authenticator = new V1HmacAuthenticator($configuration);
        $requestHeaders = ['Date' => 'Fri, 06 Jun 2014 13:39:43 GMT'];
