...
class ValueObfuscatorTest extends TestCase
{
    ...
    {
        return array(array('', 0, '', '', '', ''), array('', 3, '', '', '', '***'), array('foo', -1, '***', '***', '***', ''), array('foo', 0, '***', '***', '***', ''), array('foo', 1, '**o', 'f**', '***', '*'), array('foo', 2, '*oo', 'fo*', '***', '**'), array('foo', 3, 'foo', 'foo', '***', '***'), array('foo', 4, 'foo', 'foo', '***', '****'), array('fóo', 1, '**o', 'f**', '***', '*'), array('fóo', 2, '*óo', 'fó*', '***', '**'), array('fóo', 3, 'fóo', 'fóo', '***', '***'));
    }
}
