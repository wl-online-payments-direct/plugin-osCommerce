...
class IdempotenceTest extends TestCase
{
    ...
    public function testGetWithCallContext()
    {
        ...
        $responseHeaders = array('X-GCS-Idempotence-Request-Timestamp' => $idempotenceRequestTimestamp, 'IdempotencyResponseDatetime' => $idempotenceResponseDateTime->format(DateTimeInterface::ATOM), 'Content-Type' => 'application/json');
        $responseBody = "{}";
