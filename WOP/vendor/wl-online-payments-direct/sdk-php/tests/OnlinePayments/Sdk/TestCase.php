 ...
 * Class TestCase
 */
abstract class TestCase extends \common\modules\orderPayment\WOP\PHPUnit\Framework\TestCase
{
    /**
     * @var string
     */
    ...
    {
        return new CommunicatorConfiguration($this->getApiKey(), $this->getApiSecret(), $this->getApiEndpoint(), 'OnlinePayments');
    }
